...
import com.wmx.android.wrstar.chat.adapter.ChatLVAdapter;
...
import com.wmx.android.wrstar.views.activities.LiveActivity;
...
public class LiveChat {
    ...
    public final String TAG = "LiveChat";
    ...
    public LiveChat(LiveActivity activity, String liveId, LiveRoomPresenter presenter) {
    ...
    public void initChatView() {
        ...
        mLvAdapter = new ChatLVAdapter(activity, infos,presenter,activity.liveUserId);

        mLvAdapter.setOnAtUserListener(new ChatLVAdapter.OnAtUserListener() {
            @Override
   ...
   */
    ...
    View.OnClickListener sendClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                //  socket.send(activity.etMessage.getText() + "");
            ...
            hideSoftInputView();
//            activity.bottom.setVisibility(View.GONE);
            activity.ivSendGift.setVisibility(View.VISIBLE);
        }
    };
