...
public class ChatLVAdapter extends BaseAdapter {
    ...
    public ChatLVAdapter(Context mContext, List<ChatInfo> list, final LiveRoomPresenter presenter, final String liveUserId) {
        super();
        ...
        if (convertView == null) {
            ...
            switch (type) {
                case TYPE_CHAT:
                    ...
                    hodler.fromIcon = (CirImageView) convertView.findViewById(R.id.chatfrom_icon);
                    hodler.toIcon = (CirImageView) convertView.findViewById(R.id.chatto_icon);
        ...
        switch (type){
            case TYPE_CHAT:
                ...
                if (chatInfo.fromOrTo == 0) {
                    ...
                    hodler.time.setText(chatInfo.time);

                    if (chatInfo.chatUser != null) {
                        WRStarApplication.imageLoader.displayImage(chatInfo.chatUser.logo, hodler.fromIcon, WRStarApplication.getAvatorOptions());
                        hodler.fromName.setText(chatInfo.chatUser.name);
                    }
                    ...
                    hodler.fromIcon.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            detailsInfoDialog.setOnFocus(new DetailsInfoDialog.OnFocusListener() {
                                @Override
                                public void setFocus(boolean isFocus) {
                                    presenter.setFocus(chatInfo.chatUser.id,isFocus);
                                }
                            });

                            presenter.getOtherUserInfo(chatInfo.chatUser.id);
                    ...
                    WRStarApplication.imageLoader.displayImage(WRStarApplication.getUser().userLogo, hodler.toIcon, WRStarApplication.getAvatorOptions());
