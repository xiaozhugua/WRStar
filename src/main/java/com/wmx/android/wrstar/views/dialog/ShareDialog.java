        ...
        switch (view.getId()) {
            case R.id.ly_share_weibo:
                new ShareAction(activity)
                        ...
                        .withTitle(PreferenceUtils.getliveTitle(context))
                        .withText(PreferenceUtils.getliveContext(context))
                        .withTargetUrl(PreferenceUtils.getliveContext(context))
...
//                        .withTargetUrl("http://www.baidu.com")
    ...
    public ShareDialog(Context context, AbsBaseActivity activity) {
