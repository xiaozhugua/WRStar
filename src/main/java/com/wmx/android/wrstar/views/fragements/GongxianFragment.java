...
public class GongxianFragment extends AbsBaseFragment implements ShareSuccessView,View.OnClickListener,GetAppPaiView, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    public static final String TAG = "GongxianFragment";
    @Bind(R.id.rv_home)
    ...
    @Bind(R.id.iv_gongxian_share)
    ImageView iv_gongxian_share;

    public GetAppPaiPresenter presenter;
    GongxiandAdapter adapter;
    private String index = "1";
    String action = "3";   //"action": "2"  //1是推荐 2是邀约
    ...
    protected void initViews() {
        iv_gongxian_share.setOnClickListener(this);
