...
public class RecommendFragment extends AbsBaseFragment implements ShareSuccessView,View.OnClickListener,GetAppPaiView,RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    @Bind(R.id.iv_recommend_share)
    ImageView iv_recommend_share;

    public GetAppPaiPresenter presenter;
    GongxiandAdapter adapter;
    private String index = "1";
    String action="1";   //"action": "2"  //1是推荐 2是邀约
    ...
    protected void initViews() {
        iv_recommend_share.setOnClickListener(this);
...
//        adapter.setOnItemClickListener(new EasyRecyclerView.);
    ...
    public void getAppPaiListSuccess(GetAppPaiResponse response) {
        ...
        if(response.body!=null){
            ...
            PreferenceUtils.setRecommendTitle(getActivity(),response.body.recommendtitle);
            PreferenceUtils.setRecommendUrl(getActivity(),response.body.recommendurl);
            PreferenceUtils.setRecommendIcon(getActivity(),response.body.recommendicon);
