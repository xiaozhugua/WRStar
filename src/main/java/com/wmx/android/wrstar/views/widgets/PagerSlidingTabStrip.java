...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private ArrayList<Tags> list = new ArrayList<Tags>();
	...
	private int indicatorColor = 0xFFffcf0d;
...
//	}
	...
	public void setData(ArrayList<Tags> list){
		this.list = list;
		notifyDataSetChanged();
	}
		...
		tab.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (onTabsClickListener!=null){
					onTabsClickListener.onClick(list.get(position));
                    tab.setFocusable(true);
                  //  Toast.makeText(WRStarApplication.getContext(), list.get(position).name ,Toast.LENGTH_LONG).show();

                    LogUtil.i("tabs："+list.get(position).name);
